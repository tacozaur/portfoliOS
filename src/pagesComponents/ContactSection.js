...
const ContactSection = ({theme}) => {
  ...
  return (
    <section className='grid justify-center pb-20'>
        ...
        rounded-apple bg-white dark:bg-darkBackground-darkBg
        '>
        ...
        dark:bg-darkBackground-darkBg dark:border-1 dark:border-white/10
          ...
          dark:bg-default-blue/60
            ...
            xl:col-span-2 xl:row-span-1 rounded-apple bg-neutral-black text-white group
            '>
          ...
          <div className='
          dark:border-1 dark:border-white/10
          ...
          <div className='
          col-span-2 row-span-2
          sm:hidden md:inline-block xl:inline-block
        ...
        dark:from-darkBackground-darkBg dark:to-darkBackground-darkBg
          ...
          xl:col-span-1 bg-gradient-to-bl from-gray-950 via-gray-900 to-gray-700 rounded-apple
          '>
            <Widget
              titleColor='white'
          ...
          '>
            <Widget
              ...
              projectImage={myPortfolioImg}
            />
          </div>
          <div className='
          hidden sm:inline-block md:hidden xl:inline-block
          opacity-8 pointer-events-none
          col-span-2 row-span-1
          sm:col-span-2 sm:row-span-2
          md:col-span-1 md:row-span-1
          ...
          lg:col-span-2 lg:row-span-2
          xl:col-span-2 xl:row-span-1 bg-gradient-to-bl from-gradient-red1 via-gradient-red1 to-gradient-red2 rounded-apple
          '>
            <Widget
              titleColor='white'
