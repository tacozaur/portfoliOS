  ...
  return (
    <section className='grid justify-center pb-20'>
        ...
        dark:from-darkBackground-darkBg dark:to-darkBackground-darkBg dark:border-1 dark:border-white/10
          ...
          xl:col-span-2 bg-gradient-to-bl
        from-white via-white to-white/10 rounded-apple
          '>
            <Widget
              title='PortfoliOS - My Website'
        ...
        dark:from-darkBackground-darkBg dark:to-darkBackground-darkBg dark:border-1 dark:border-white/10
          ...
          lg:col-span-2 lg:row-span-2
          xl:col-span-2 bg-gradient-to-bl
        from-gradient-green1 via-gradient-green1 to-gradient-green2 rounded-apple
          '>
            <Widget
              titleColor='white'
        ...
        dark:from-darkBackground-darkBg dark:to-darkBackground-darkBg dark:border-1 dark:border-white/10
          ...
          lg:col-span-2 lg:row-span-2
          xl:col-span-2 bg-gradient-to-bl
        from-gradient-red1 via-gradient-red1 to-gradient-red2 rounded-apple
          '>
            <Widget
              titleColor='white'
          ...
          lg:col-span-2 lg:row-span-2
          xl:col-span-2 bg-gradient-to-bl
        from-gray-950 via-gray-900 to-gray-700 rounded-apple
          '>
            <Widget
              titleColor='white'
          ...
          xl:col-span-2 rounded-apple bg-neutral-black text-white group
          '>
          ...
          <div className='
        dark:bg-default-blue/60
          col-span-2 row-span-2 xl:row-span-1 bg-default-blue text-white rounded-apple lg:col-span-2 lg:row-span-2 group'>
             <a href='https://www.behance.net/emilianpirtea1' target='_blank' rel='noopener noreferrer'>
              <SmallWidget content={<FaBehance className='transition-all duration-200 text-8xl group-hover:text-7xl'/>}/>
            </a> 
          </div>
          <div className='
        dark:bg-darkBackground-darkBg
          col-span-2 row-span-2
          sm:col-span-2 sm:row-span-1
          md:col-span-1 md:row-span-2
          lg:col-span-2 lg:row-span-2
          xl:col-span-1 xl:row-span-2 bg-white rounded-apple opacity-40 pointer-events-none
          '>
            <PathWidget/>
          </div>
          <div className='
        dark:bg-darkBackground-darkBg
          ...
          xl:col-span-1 bg-blue-700/60 rounded-apple group
          '>
            <a href='https://www.linkedin.com/in/emilian-pirtea-59a748232' target='_blank' rel='noopener noreferrer'>
              <SmallWidget content={<BsLinkedin color='white' className='transition-all duration-200 text-8xl group-hover:text-7xl'/>}/>
            </a>
          </div>
          <div className="
        ...
        dark:bg-darkBackground-darkBg
          ...
          md:col-span-1 md:row-span-1
          lg:col-span-2 lg:row-span-1
          xl:col-span-1 xl:row-span-1 bg-neutral-black rounded-apple text-white group
          '>
            <a href='https://www.instagram.com/tacotuesday.everyday/' target='_blank' rel='noopener noreferrer'>
              <SmallWidget content={<BsInstagram className='transition-all duration-200 text-8xl group-hover:text-7xl'/>}/>
            </a>
          </div>
          <div className='
          col-span-1 row-span-1
          ...
          xl:row-span-1 xl:col-span-1 rounded-apple overflow-hidden
          '>
            <SwiperWidget
            firstImg={FirstImg}
            secondImg={SecondImg}
